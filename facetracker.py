...
keyboard.on_press_key("p", lambda _:pyautogui.moveTo(0, 0, duration=1))
...
if os.name == 'nt':
    ...
    parser.add_argument("-W", "--width", type=int, help="Set camera andaw RGB  rwidth", default=640)
    ...
    parser.add_argument("-Z", "--move", type=int, help="When set to 1, controls the mouse on screen", default=0)
else:
    ...
    while repeat or input_reader.is_open():
        ...
        try:
            ...
            for face_num, f in enumerate(faces):
                ...
                if args.silent == 0:
                    #print(f"{f.euler[0]} {f.euler[1]} {f.euler[2]}")
                    ...
                    print(f"MOUTH: {f.current_features['mouth_open']}")
                detected = True
                if not f.success:
